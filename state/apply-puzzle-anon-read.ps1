# Applies supabase/migrations/20260924180000_puzzle_readable_by_anon.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-anon-read.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-anon-read.mjs"; $code = $LASTEXITCODE }
