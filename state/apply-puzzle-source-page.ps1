# Applies supabase/migrations/20260924160000_puzzle_source_page.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-source-page.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-source-page.mjs"; $code = $LASTEXITCODE }
