# Applies supabase/migrations/20260920125000_trial_three_days.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-trial-three-days.ps1"
# Loads SUPABASE_ACCESS_TOKEN from analytics-studio\.env into the environment and never prints it.
# Safe to re-run: a function body that no longer says 14 days is left alone.
...
Push-Location $repo
try { node "$repo\scripts\apply-trial-three-days.mjs"; $code = $LASTEXITCODE }
