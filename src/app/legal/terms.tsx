...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'The same applies to audio: a soundtrack you add to a binder must be yours or licensed for public playback, and you attest to that when you upload it. Commercial recordings from a streaming service are not licensed for this.',
      'You agree to indemnify michi-maker for claims arising from art, audio or content you added in violation of these terms.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'michi-maker is free to start. Optional paid plans (PRO, and a one-time Founder membership, described on the Plans page) and a one-time per-binder print unlock are available. Payments are processed by Stripe, our payment provider; michi-maker never sees or stores your card details. Prices are shown before you buy, plus any taxes where required.',
      ...
      // NOT "print credits". This paragraph is the stated basis for refusing a partial refund, so
      // it is the paragraph a disputed charge gets decided on — and it named a benefit the 2026-09
      // rework removed: includedPrintsPerMonth is 0 on every tier, so no plan grants a print. What
      // plans do deliver immediately is the limits coming off, which is the true version of the
      // same argument.
      'Because plans deliver their value immediately (higher limits, unlocked searches, digital output), we do not refund partial billing periods, except where the law of your country requires it. The one-time binder PDF unlock is delivered digital content: once your download has been generated it cannot be refunded. If a charge went wrong or you believe you were billed in error, contact support@michi-maker.com and we will make it right.',
      'The free 3-day PRO trial requires no card and never turns into a charge on its own. When a trial or subscription ends and you are over the free limits, your extra binders are locked, not deleted: after a 3-day grace period the excess is archived, and it comes back when you subscribe again.',
    ],
  },
  {
