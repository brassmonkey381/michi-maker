# Applies supabase/migrations/20260922120000_feedback_responses.sql to the live app project.
...
Push-Location $repo
try { node "$repo\scripts\apply-feedback-responses.mjs"; $code = $LASTEXITCODE }
