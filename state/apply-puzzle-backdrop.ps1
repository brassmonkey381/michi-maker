# Applies supabase/migrations/20260924140000_puzzle_backdrop.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-backdrop.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-backdrop.mjs"; $code = $LASTEXITCODE }
