# Applies supabase/migrations/20260923140000_daily_puzzle.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-daily-puzzle.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-daily-puzzle.mjs"; $code = $LASTEXITCODE }
