# Applies the page descriptions in state\thirty-notes.json to the live binder (descriptions only).
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-thirty-notes.ps1"
...
Push-Location $repo
try { node "$PSScriptRoot\apply-thirty-notes.mjs"; $code = $LASTEXITCODE }
