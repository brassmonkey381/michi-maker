# READ-ONLY. Reports what share of pockets are stranded at the swap park row. Writes nothing.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\check-stranded-slots.ps1"
...
Push-Location $repo
try { node "$repo\scripts\check-stranded-slots.mjs"; $code = $LASTEXITCODE }
