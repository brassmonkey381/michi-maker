# Applies supabase/migrations/20260923150000_hidden_from_feeds.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-hidden-from-feeds.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-hidden-from-feeds.mjs"; $code = $LASTEXITCODE }
