# Applies supabase/migrations/20260924150000_puzzle_card_images.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-card-images.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-card-images.mjs"; $code = $LASTEXITCODE }
