# Applies supabase/migrations/20260924170000_puzzle_day_pacific.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-day-pacific.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-day-pacific.mjs"; $code = $LASTEXITCODE }
