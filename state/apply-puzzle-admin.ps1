# Applies supabase/migrations/20260924120000_puzzle_admin.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-puzzle-admin.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-puzzle-admin.mjs"; $code = $LASTEXITCODE }
