 ...
 * "SWSH04: Vivid Voltage", and beside a series chip already reading SWSH that prefix is saying the
 * same thing twice in the scarcest space on the card. Sets with no prefix ("Champion's Path") are
 * returned untouched.
 *
