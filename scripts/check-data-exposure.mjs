...
console.error(`\nFix in the DATA project (see docs/DATA-SERVER.md), for each relation above:`);
console.error(`  REVOKE SELECT (${Object.keys(GUARDED).join(', ')}) ON <relation> FROM anon, authenticated;`);
