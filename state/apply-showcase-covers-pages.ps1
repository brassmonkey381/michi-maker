# Applies supabase/migrations/20260924190000_showcase_covers_pages.sql to the live app project.
#   powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Brian\source\repos\tcgscan\michi-maker\state\apply-showcase-covers-pages.ps1"
...
Push-Location $repo
try { node "$repo\scripts\apply-showcase-covers-pages.mjs"; $code = $LASTEXITCODE }
